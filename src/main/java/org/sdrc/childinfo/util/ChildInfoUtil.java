...
public class ChildInfoUtil {
	 ...
	 * @return
	 */
	public static Font getHeaderFont(SXSSFWorkbook workbook) {
	 ...
	 * @author Subrata
	 */
	public static CellStyle getStyleForCenter(SXSSFWorkbook workbook) {
	...
	public static CellStyle getStyleForProjectName(SXSSFWorkbook workbook) {
	 ...
	 * @return
	 */
	public static Font getHeaderFontProject(SXSSFWorkbook workbook) {
		Font headerFont = workbook.createFont();
        headerFont.setBold(true);
	...
	public static CellStyle getStyleForOtherHeader(SXSSFWorkbook workbook) {
	 ...
	 * @return
	 */
	public static Font getHeaderFontOtherHeader(SXSSFWorkbook workbook) {
		Font headerFont = workbook.createFont();
        headerFont.setBold(true);
        headerFont.setFontHeightInPoints((short) 12);
        headerFont.setColor(IndexedColors.BLACK.getIndex());
	...
	public static CellStyle getStyleForOtherDateHeader(SXSSFWorkbook workbook) {
