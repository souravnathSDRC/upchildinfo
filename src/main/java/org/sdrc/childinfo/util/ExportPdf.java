...
public class ExportPdf implements PdfPTableEvent {
    ...
    public String createPdfForProjectionAndBurden(String topBottomimg, String legendimg, DashboardExport dashboardExport,List<UtDataModel> utDataModelList) throws IOException{
...
//			top3 bottom3
    ...
    public PdfPTable createTableForProjectionAndBurden(DashboardExport dashboardExport, Document document,List<UtDataModel> utDataModelList) throws DocumentException{
		...
		for (UtDataModel utDataModel : utDataModelList) {	
			...
			PdfPCell utData4 = new PdfPCell(new Paragraph(
					String.valueOf(convertedValue), small));
			utData4.setHorizontalAlignment(Element.ALIGN_CENTER);
			utData4.setVerticalAlignment(Element.ALIGN_MIDDLE);
			if(evenrow)
				utData4.setBackgroundColor(mycolor);
